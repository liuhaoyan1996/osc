      ...
      <>
        ...
        <div className="xpanse-BillingGroupHeader">
          ...
          <div className="xpanse-BillingGroupHeader-detail-container">
            <div className="xpanse-BillingGroupHeader-detail-title">Current accumulated monthly bill</div>
            <div className="aiven-BillingGroupHeader-detail-balance">$ 11.37 USD</div>
            <div className="xpanse-BillingGroupHeader-detail-payment">No credit card assigned</div>
          </div>
        </div>
        <div>
