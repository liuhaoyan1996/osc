...
import {ApacheKafka,Redis,Mysql,OpenSearch,Grafana,InfluxDB} from './SvgObject'

function SelectService(props: any) {
  const list = [
    {
      picture: ApacheKafka,
      name: 'ApacheKafka',
            ...
            return(
                <div key={index} className={isSelected === index ? 'xpanse-ServiceTypeOption-detail-selected' : 'xpanse-ServiceTypeOption-detail'}
                  ...
                  <div className="xpanse-ServiceTypeOption-image">
                    <img src={item.picture} className="xpanse-ServiceTypeOption-service-icon" />
                  </div>
